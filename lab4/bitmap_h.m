...
bitmap("kanada.jpg", 20, 20, 1, 3, true)
function bitmap(filename,elementsx,elementsy,maxerror,max_refinement_level,color_edges_black)

% BEGIN CHANGES
% read image from file
XX = imread(filename);
XX_gray = 0.299*XX(:,:,1) + 0.587*XX(:,:,2) + 0.114*XX(:,:,3);
XX(:,:,1) = XX_gray;
XX(:,:,2) = XX_gray;
XX(:,:,3) = XX_gray;
% END CHANGES
